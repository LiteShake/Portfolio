...
const StellaLM = () => {
    return (
        <div className='bg-[url("../../assets/stla.jpg")] text-sky-400 font-semibold p-3 m-4 rounded-xl shadow-lg shadow-sky-200' style={{ backgroundImage: `url(${bluepic})` }}>
            <div className='text-3xl text-center text-sky-500 font-semibold px-3 py-4 flex flex-row w-full'>
            ...
            <div className=''>
                <div className='py-4 md:py-2 text-white font-semibold text-xl px-2 md:px-2 m-1 place-content-center'>
                    <ul>
                        <li className='transition duration-500 ease-in-out backdrop-blur-sm bg-sky-800/60 p-3 my-2 hover:text-white hover:backdrop-blur-xl rounded-xl'>
