  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row-reverse md:mx-24 '>
      <div className='py-4 text-slate-700 font-semibold text-2xl px-2 md:px-6 m-1 place-content-center text-center md:text-left'>
        I’m <span className='bg-gradient-to-r from-pink-600 to-pink-400 text-transparent bg-clip-text' >Viswanathan</span>. Computer Science student specializing in Artificial Intelligence. I work on <span className='text-green-500'>AI</span> and things.. 
