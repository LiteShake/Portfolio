                    ...
                    <div className='py-4 md:py-2 text-white font-semibold text-xl px-2 md:px-2 m-1 place-content-center'>
                        <ul>
                            ...
                            <li className='transition duration-500 ease-in-out backdrop-blur-md hover:shadow-md hover:shadow-green-500/50 bg-green-800/60 p-3 my-2 hover:text-white hover:backdrop-blur-xl rounded-xl flex place-content-evenly'>
                                <a href="https://ieeexplore.ieee.org/abstract/document/10306707" className='text-green-500 bg-slate-100 p-1 px-4 rounded-md'>IEEE</a>
                                <a href="https://scholar.google.com/citations?view_op=view_citation&hl=en&user=NVzRlGQAAAAJ&citation_for_view=NVzRlGQAAAAJ:u5HHmVD_uO8C" className='text-green-500 bg-slate-100 p-1 px-4 rounded-md'>Google Scholar</a>
                            </li>
                        </ul>
                    </div>
                </div>
